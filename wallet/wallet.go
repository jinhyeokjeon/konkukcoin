...
const (
	fileName string = "konkukcoin.wallet"
)
...
func Sign(w *wallet, hexPayload string) string {
	payloadAsByte, err := hex.DecodeString(hexPayload)
	utils.HandleErr(err)
...
func restoreBigInts(hexPayload string) (*big.Int, *big.Int, error) {
